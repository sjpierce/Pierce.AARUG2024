...
subtitle: "Presentation to Ann Arbor R Users' Group, Ann Arbor, MI"
author: "Steven J. Pierce"
institute: "Center for Statistical Training and Consulting, Michigan State University"
date: November 14, 2024
title-slide-attributes: 
  data-notes: 1 hr (45-50 min talk + 10-15 min Q & A) My name is Steven Pierce. 
              My talk today focuses on how R and Quarto provide a foundation 
              for generating reproducible statistical analyses and reports. 
              My goal is promote reproducibility and encourage you to build your 
              capacity and competency by adopting principles, practices, and 
              tools for reproducible research. Hopefully, sharing my experience 
              and insights will persuade you why that's beneficial, motivate you 
              to do so, and accelerate your learning journey. My slides and 
              example files are available from the link at the bottom of the 
              screen. The slides have many links to resources built right in and 
              are themselves a reproducible product. So jot down that link or my 
              email address so you can get them later. For now, enjoy this 
              guided tour. 
...
format: 
  revealjs:
    ...
    footer: <a href="https://github.com/sjpierce/Pierce.AARUG2024">https://github.com/sjpierce/Pierce.AARUG2024</a>
...
already thinking about right now. They are: "What do you mean by reproducible?"
...
verify them or conduct alternative analyses. Some of you may work in the private 
sector rather than academia. This is still a worthwhile goal even if you work in 
a business and are creating statistical reports that will not turn into academic 
publications. That just means your audience may be smaller.
:::
...
matters is how we work and share the materials. I suspect it’s easier to apply 
the principles to quantitative methods and those are my forte as a 
statistician--and probably yours as R users--so I'll focus on that route to 
...
syntax files to automate tasks, switching to R instead of SPSS, adding comments
in the syntax files, adopting file naming conventions, and so on. But part of
the problem was that the software tools weren't integrated and lacked support
for better workflows. Technology has vastly improved since my student days, but
many people still use manual workflows like those I just described. They don't
know what is possible now. Given what I've learned in recent years, if asked to
resume using those older tools and workflows, I'd probably break out my favorite
Spock quote.
:::
...
now. As you all know, R is a fantastic tool for managing and analyzing data
and creating figures. RStudio Desktop is an excellent editor for working with R
that also simplifies using Quarto, Git, and GitHub. Quarto supports creating
dynamic documents that render to a variety of output formats (HTML, PDF, Word,
PowerPoint, etc.), TinyTex helps Quarto produce nice PDF output, while Git and 
GitHub together support version control, collaboration, and sharing materials. Collectively, they comprise an elegant, integrated set of tools for doing 
...
stakeholder. To paraphrase a former colleague "your worst collaborator is often 
the you from 6 months ago who skipped writing down some key details because you 
foolishly assumed you'd remember them later."
...
strictly required. Use a scripts to automate recording information about the
...
::: {.notes}
I will show you an some example files in a minute but it helps to understand 
a little about the anatomy of a Quarto script first. It is just a plain text 
file with a name that ends in `.qmd`. It uses a simple markdown syntax to format
the output it will render. The top of the file is the YAML header, which
contains document-level metadata, options, and parameters. The body of the file
contains headings, narrative text, code, citations, links, and cross-references.
:::
